...
{
    private static CBackgroundPanel sInstance = null;
	...
	public static CBackgroundPanel getInstance(Image pImage)
	{
		if (sInstance == null)
		{
			sInstance = new CBackgroundPanel(pImage);
		}
		return sInstance;
	}
	 ...
	 */
	private CBackgroundPanel(Image image)
	{
		this(image, SCALED);
	}
	 ...
	 */
	public CBackgroundPanel(Image image, int style)
	{
		setImage( image );
		setStyle( style );
	 ...
	 */
	public CBackgroundPanel(Image image, int style, float alignmentX, float alignmentY)
	{
		setImage( image );
		setStyle( style );
	 ...
	 */
	public CBackgroundPanel(Paint painter)
	{
		setPaint( painter );
		setLayout( new BorderLayout() );
	}
